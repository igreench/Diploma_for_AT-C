...
public class Request {
    UUID guid;
    public Request(UUID guid){
        this.guid = guid;
    }

    public Element generateRequest() throws Exception {
    ...
    public Element createBody() throws Exception {
        Element body = DocumentHelper.createElement("soap:Body")
                ...
                .addNamespace("ns3", "http://www.w3.org/2004/08/xop/include")
                .addNamespace("smev", "http://smev.gosuslugi.ru/rev120315")
                .addAttribute("wsu:Id","body");
        Element createRequestRequest = body.addElement("ns4:createRequestRequest")
                .addNamespace("", "http://smev.gosuslugi.ru/rev111111");
        Message message = new Message();
        message.createMessage(createRequestRequest, "request", guid);
        MessageData messageData = new MessageData();
        messageData.createMessageData(createRequestRequest, "request", null, guid);
        //Element messageData = MessageData.createMessageData(createRequestRequest, "request");
        return body;
    }
}
